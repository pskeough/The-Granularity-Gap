...
2. PER-JUDGE DECOMPOSITION. For each judge independently: how much of its own severity variance
   ...
   converts the Granularity Gap from a within-instrument identity into a property of
...
def main() -> None:
    ...
    out += ["## 2. Per-judge decomposition of the Granularity Gap", "",
    ...
    out += ["## 3. The same gap appears BETWEEN judges", "",
            ...
            "Granularity Gap across instruments, and it does not rest on the within-judge "
            "algebraic identity.", "",
